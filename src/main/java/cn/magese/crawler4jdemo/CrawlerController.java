...
//        collections.add(new BasicHeader("User-Agent", "Mozilla/5.0 (iPhone; CPU iPhone OS 10_2_1 like Mac OS X) AppleWebKit/602.4.6 (KHTML, like Gecko) Mobile/14D27 MicroMessenger/6.5.5 NetType/WIFI Language/zh_CN"));
//        collections.add(new BasicHeader("x-forwarded-for", "180.143.247.71"));
